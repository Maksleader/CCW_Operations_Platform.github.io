...
import { CareProviderPortalCommonModule } from '@shared/common/common.module';
...
function initializeLocalForage() {
    localForage.config({
        ...
        name: 'CareProviderPortal',
        version: 1.0,
        storeName: 'abpzerotemplate_local_storage',
        description: 'Cached data for CareProviderPortal',
    });
}
...
@NgModule({
    imports: [
        ...
        AppModule,
        CareProviderPortalCommonModule.forRoot(),
        ServiceProxyModule,
        HttpClientModule,
        RootRoutingModule,
        NgxSpinnerModule,
