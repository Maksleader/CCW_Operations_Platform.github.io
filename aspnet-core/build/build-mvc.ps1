...
$webMvcFolder = Join-Path $slnFolder "src/CareProviderPortal.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/CareProviderPortal.Web.Public"
...
dotnet restore CareProviderPortal.Web.sln
