...
using CareProviderPortal.Auditing.Exporting;
...
using EntityHistoryHelper = CareProviderPortal.EntityHistory.EntityHistoryHelper;

namespace CareProviderPortal.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : CareProviderPortalAppServiceBase, IAuditLogAppService
    {
