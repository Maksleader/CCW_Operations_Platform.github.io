...
namespace CareProviderPortal.Authorization.Users.Delegation
{
    [AbpAuthorize]
    public class UserDelegationAppService : CareProviderPortalAppServiceBase, IUserDelegationAppService
    {
