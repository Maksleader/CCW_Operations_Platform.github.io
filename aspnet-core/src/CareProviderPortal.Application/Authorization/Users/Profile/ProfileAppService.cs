...
using CareProviderPortal.Authorization.Users.Profile.Cache;
using CareProviderPortal.Authorization.Users.Profile.Dto;
using CareProviderPortal.Configuration;
using CareProviderPortal.Friendships;
using CareProviderPortal.Gdpr;
using CareProviderPortal.Net.Sms;
using CareProviderPortal.Security;
using CareProviderPortal.Storage;
using CareProviderPortal.Timing;
using SixLabors.ImageSharp;
using SixLabors.ImageSharp.Formats;
using SixLabors.ImageSharp.Processing;

namespace CareProviderPortal.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : CareProviderPortalAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("CareProviderPortal",
