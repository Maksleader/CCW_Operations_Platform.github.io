...
using CareProviderPortal.Authorization.Permissions;
...
using CareProviderPortal.Authorization.Users.Exporting;
...
namespace CareProviderPortal.Authorization.Users
{
    ...
    public class UserAppService : CareProviderPortalAppServiceBase, IUserAppService
    {
