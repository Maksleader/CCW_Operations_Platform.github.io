...
using CareProviderPortal.Caching.Dto;

namespace CareProviderPortal.Caching
{
    [AbpAuthorize(AppPermissions.Pages_Administration_Host_Maintenance)]
    public class CachingAppService : CareProviderPortalAppServiceBase, ICachingAppService
    {
