...
using CareProviderPortal.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace CareProviderPortal.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : CareProviderPortalAppServiceBase, IDashboardCustomizationAppService
    {
