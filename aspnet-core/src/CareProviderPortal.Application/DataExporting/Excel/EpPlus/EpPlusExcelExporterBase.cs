...
namespace CareProviderPortal.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : CareProviderPortalServiceBase, ITransientDependency
    {
