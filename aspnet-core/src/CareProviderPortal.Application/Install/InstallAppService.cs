...
using CareProviderPortal.Migrations.Seed.Host;
...
namespace CareProviderPortal.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : CareProviderPortalAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<CareProviderPortalDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{CareProviderPortalConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{CareProviderPortalConsts.ConnectionStringName}", constring);
        }
