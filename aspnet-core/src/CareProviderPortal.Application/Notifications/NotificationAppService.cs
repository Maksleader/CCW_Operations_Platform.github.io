...
using CareProviderPortal.Organizations;

namespace CareProviderPortal.Notifications
{
    [AbpAuthorize]
    public class NotificationAppService : CareProviderPortalAppServiceBase, INotificationAppService
    {
