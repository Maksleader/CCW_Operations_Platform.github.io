...
{
    public class SessionAppService : CareProviderPortalAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = CareProviderPortalConsts.Currency,
                        CurrencySign = CareProviderPortalConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = CareProviderPortalConsts.AllowTenantsToChangeEmailSettings,
