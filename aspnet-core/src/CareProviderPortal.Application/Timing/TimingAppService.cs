...
using CareProviderPortal.Timing.Dto;
using TimeZoneConverter;

namespace CareProviderPortal.Timing
{
    public class TimingAppService : CareProviderPortalAppServiceBase, ITimingAppService
    {
