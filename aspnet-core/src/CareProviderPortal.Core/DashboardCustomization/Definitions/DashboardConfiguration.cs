...
namespace CareProviderPortal.DashboardCustomization.Definitions
{
    public class DashboardConfiguration
    {
        ...
        public DashboardConfiguration()
        {
            ...
            var dateRangeFilter = new WidgetFilterDefinition(
                CareProviderPortalDashboardCustomizationConsts.Filters.FilterDateRangePicker,
            ...
            var dailySales = new WidgetDefinition(
                CareProviderPortalDashboardCustomizationConsts.Widgets.Tenant.DailySales,
                "WidgetDailySales",
            ...
            var generalStats = new WidgetDefinition(
                CareProviderPortalDashboardCustomizationConsts.Widgets.Tenant.GeneralStats,
                "WidgetGeneralStats",
                side: MultiTenancySides.Tenant,
            ...
            var profitShare = new WidgetDefinition(
                CareProviderPortalDashboardCustomizationConsts.Widgets.Tenant.ProfitShare,
                "WidgetProfitShare",
                side: MultiTenancySides.Tenant,
                permissionDependency: simplePermissionDependencyForTenantDashboard
            );
            ...
            var memberActivity = new WidgetDefinition(
                CareProviderPortalDashboardCustomizationConsts.Widgets.Tenant.MemberActivity,
            ...
            var regionalStats = new WidgetDefinition(
                CareProviderPortalDashboardCustomizationConsts.Widgets.Tenant.RegionalStats,
                "WidgetRegionalStats",
                side: MultiTenancySides.Tenant,
                permissionDependency: simplePermissionDependencyForTenantDashboard
            );
            ...
            var salesSummary = new WidgetDefinition(
                CareProviderPortalDashboardCustomizationConsts.Widgets.Tenant.SalesSummary,
                "WidgetSalesSummary",
                usedWidgetFilters: new List<string>() { dateRangeFilter.Id },
                side: MultiTenancySides.Tenant,
                permissionDependency: simplePermissionDependencyForTenantDashboard
            ...
            var topStats = new WidgetDefinition(
                CareProviderPortalDashboardCustomizationConsts.Widgets.Tenant.TopStats,
                "WidgetTopStats",
                side: MultiTenancySides.Tenant,
                permissionDependency: simplePermissionDependencyForTenantDashboard
            );
            ...
            var incomeStatistics = new WidgetDefinition(
                CareProviderPortalDashboardCustomizationConsts.Widgets.Host.IncomeStatistics,
            ...
            var hostTopStats = new WidgetDefinition(
                CareProviderPortalDashboardCustomizationConsts.Widgets.Host.TopStats,
                "WidgetTopStats",
                side: MultiTenancySides.Host,
                permissionDependency: simplePermissionDependencyForHostDashboard
            );
            ...
            var editionStatistics = new WidgetDefinition(
                CareProviderPortalDashboardCustomizationConsts.Widgets.Host.EditionStatistics,
            ...
            var subscriptionExpiringTenants = new WidgetDefinition(
                CareProviderPortalDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants,
            ...
            var recentTenants = new WidgetDefinition(
                CareProviderPortalDashboardCustomizationConsts.Widgets.Host.RecentTenants,
                "WidgetRecentTenants",
                side: MultiTenancySides.Host,
                usedWidgetFilters: new List<string>() { dateRangeFilter.Id },
                permissionDependency: simplePermissionDependencyForHostDashboard
            ...
            var defaultTenantDashboard = new DashboardDefinition(
                CareProviderPortalDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                new List<string>
                {
            ...
            var defaultHostDashboard = new DashboardDefinition(
                CareProviderPortalDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                new List<string>
                {
                    incomeStatistics.Id,
                    hostTopStats.Id,
