...
{
    public class StripeGatewayManager : CareProviderPortalServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "CareProviderPortal";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + CareProviderPortalConsts.Currency;
        }
