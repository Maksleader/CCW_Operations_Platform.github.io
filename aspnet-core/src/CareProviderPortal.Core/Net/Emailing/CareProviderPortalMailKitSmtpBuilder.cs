...
{
    public class CareProviderPortalMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public CareProviderPortalMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(CareProviderPortalConsts.LocalizationSourceName, name);
        }
    }
}