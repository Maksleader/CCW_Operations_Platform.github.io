...
{
    public class UserRepository : CareProviderPortalRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<CareProviderPortalDbContext> dbContextProvider)
