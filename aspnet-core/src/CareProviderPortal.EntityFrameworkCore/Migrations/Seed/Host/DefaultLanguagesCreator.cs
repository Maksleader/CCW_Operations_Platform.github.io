...
namespace CareProviderPortal.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = CareProviderPortalConsts.MultiTenancyEnabled ? null : (int?)1;
            return new List<ApplicationLanguage>
            {
                ...
                new ApplicationLanguage(tenantId, "az", "Azərbaycan dili", "famfamfam-flags az"),
            };
        }

        public DefaultLanguagesCreator(CareProviderPortalDbContext context)
        {
            _context = context;
        }
