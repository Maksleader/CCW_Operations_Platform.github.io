...
using CareProviderPortal.EntityFrameworkCore.Repositories;

namespace CareProviderPortal.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : CareProviderPortalRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<CareProviderPortalDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
