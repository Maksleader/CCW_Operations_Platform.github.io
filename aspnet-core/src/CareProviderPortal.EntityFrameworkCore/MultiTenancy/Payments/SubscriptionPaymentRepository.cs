...
{
    public class SubscriptionPaymentRepository : CareProviderPortalRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<CareProviderPortalDbContext> dbContextProvider)
