...
namespace CareProviderPortal.Organizations
{
    public class UserOrganizationUnitRepository : CareProviderPortalRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<CareProviderPortalDbContext> dbContextProvider)
