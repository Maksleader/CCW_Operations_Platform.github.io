...
namespace CareProviderPortal.Core.Base
{
    public abstract class CareProviderPortalQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected CareProviderPortalQueryBase(string fieldName,
