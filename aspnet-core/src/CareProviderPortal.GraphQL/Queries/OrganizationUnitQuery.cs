...
using CareProviderPortal.Core.Base;
using CareProviderPortal.Core.Extensions;
using CareProviderPortal.Dto;
using CareProviderPortal.Types;

namespace CareProviderPortal.Queries
{
    public class OrganizationUnitQuery : CareProviderPortalQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
