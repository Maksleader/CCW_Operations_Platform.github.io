...
using CareProviderPortal.Commands;
using CareProviderPortal.Core.Threading;
using CareProviderPortal.Models.NavigationMenu;
using CareProviderPortal.Services.Navigation;
...
using CareProviderPortal.ApiClient;
using CareProviderPortal.Controls;
using CareProviderPortal.Dto;
using CareProviderPortal.Extensions;
using CareProviderPortal.Localization;
using CareProviderPortal.UI;
using CareProviderPortal.UI.Assets;
using CareProviderPortal.Views;
using DependencyResolver = CareProviderPortal.Core.Dependency.DependencyResolver;
...
namespace CareProviderPortal.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "CareProviderPortal";
