...
{
    public class CareProviderPortalAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public CareProviderPortalAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
