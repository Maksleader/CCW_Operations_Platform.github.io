...
/// </summary>
public static class CareProviderPortalJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, CareProviderPortalAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
