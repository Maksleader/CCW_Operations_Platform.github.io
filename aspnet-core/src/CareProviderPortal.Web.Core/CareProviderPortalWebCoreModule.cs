...
using CareProviderPortal.Authentication.TwoFactor;
...
using CareProviderPortal.Web.Authentication.JwtBearer;
using CareProviderPortal.Web.Authentication.TwoFactor;
using CareProviderPortal.Web.Chat.SignalR;
using CareProviderPortal.Web.Common;
using CareProviderPortal.Web.Configuration;
using CareProviderPortal.Web.DashboardCustomization;

namespace CareProviderPortal.Web
{
    [DependsOn(
        typeof(CareProviderPortalApplicationModule),
        typeof(CareProviderPortalEntityFrameworkCoreModule),
    ...
    public class CareProviderPortalWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public CareProviderPortalWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(CareProviderPortalApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CareProviderPortalWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(CareProviderPortalWebCoreModule).Assembly);
        }
