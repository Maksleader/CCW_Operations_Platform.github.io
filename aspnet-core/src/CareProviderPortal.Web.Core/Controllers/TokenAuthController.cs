...
using CareProviderPortal.Authentication.TwoFactor.Google;
using CareProviderPortal.Authorization;
using CareProviderPortal.Authorization.Accounts.Dto;
...
namespace CareProviderPortal.Web.Controllers
{
    ...
    public class TokenAuthController : CareProviderPortalControllerBase
    {
