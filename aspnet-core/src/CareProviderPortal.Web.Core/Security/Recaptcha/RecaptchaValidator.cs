...
namespace CareProviderPortal.Web.Security.Recaptcha
{
    public class RecaptchaValidator : CareProviderPortalServiceBase, IRecaptchaValidator, ITransientDependency
    {
