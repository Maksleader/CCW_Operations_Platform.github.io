...
namespace CareProviderPortal.Web.Startup
{
    ...
    public class CareProviderPortalWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public CareProviderPortalWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CareProviderPortalWebHostModule).GetAssembly());
        }
