...
namespace CareProviderPortal.Web.Public.Startup
{
    [DependsOn(
        typeof(CareProviderPortalWebCoreModule)
    )]
    public class CareProviderPortalWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public CareProviderPortalWebFrontEndModule(IWebHostEnvironment env, CareProviderPortalEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CareProviderPortalWebFrontEndModule).GetAssembly());
        }
    }
}
