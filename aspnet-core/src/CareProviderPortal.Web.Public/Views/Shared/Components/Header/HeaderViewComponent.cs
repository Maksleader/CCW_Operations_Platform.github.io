...
using CareProviderPortal.Web.Public.Startup;
using CareProviderPortal.Web.Session;

namespace CareProviderPortal.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : CareProviderPortalViewComponent
    {
