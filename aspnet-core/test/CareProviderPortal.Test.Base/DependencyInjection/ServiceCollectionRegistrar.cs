...
namespace CareProviderPortal.Test.Base.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<CareProviderPortalDbContext>>()
            ...
            new CareProviderPortalDbContext(builder.Options).Database.EnsureCreated();
        }
