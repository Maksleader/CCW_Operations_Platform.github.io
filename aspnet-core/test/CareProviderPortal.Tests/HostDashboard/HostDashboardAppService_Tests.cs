...
using CareProviderPortal.MultiTenancy.HostDashboard;
...
namespace CareProviderPortal.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(CareProviderPortalDbContext context, SubscriptionPayment subscriptionPayment)
        {
